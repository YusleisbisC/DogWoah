...
export const Navbar = () => {
  ...
  const adminUserIds = ["u1eBSrG3padEmsMnfrkuV0o9MmX2", "kT1vMgwwiPdJLDXFN8nFvrausKw2"]; // Agrega los IDs de los usuarios administradores aquí
      ...
      <div style={{ width: "100%" }}>
        <div className="container" style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
          ...
          <ul className="navbar-nav ml-auto">
            {user && adminUserIds.includes(user.uid) && ( // Mostrar solo para usuarios administradores
              <li className="nav-item">
                <Link className="nav-link" to="/AdminProducts/">Administrador</Link>
              </li>
            )}
            <li className="nav-item" >
            ...
            <li className="nav-item"  >
              <Dropdown  show={showCategoriesMenu} onToggle={toggleCategoriesMenu} >
                <Dropdown.Toggle as="span" className="nav-link">
                  <Link style={{textDecoration:"none"}}  to="/productos/">Productos</Link >
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item className="nav-link">
                    <Link style={{textDecoration:"none"}} to="/productos/Baño">Baño</Link>
                  </Dropdown.Item>
                  <Dropdown.Item className="nav-link">
                    <Link style={{textDecoration:"none"}} to="/productos/Alimentos">Alimentos</Link>
                  </Dropdown.Item>
                  <Dropdown.Item className="nav-link">
                    <Link  style={{textDecoration:"none"}} to="/productos/Brinquedos">Brinquedos</Link>
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            </li>
