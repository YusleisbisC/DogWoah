...
const Slideshow = () => {
  return (
    ...
    <Carousel showArrows={false} showThumbs={false} infiniteLoop={true} autoPlay={true}>
      <div >
        <img src="https://media.istockphoto.com/id/1090311338/es/foto/perro-feliz-con-pizarra-con-texto-bienvenida-dice-hola-bienvenida-abiertas-contra-la-pared.jpg?s=612x612&w=0&k=20&c=xn5HPtDXJlFSnMb0SOLtEiHAowTTZZQD8qV68cFTeBw=" alt="Imagen 1" />
      </div>
      <div>
